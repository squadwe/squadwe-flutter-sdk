...
// in squadwe_client_sdk/test/data/remote/squadwe_client_api_interceptor_test.dart.
...
class _FakeSquadweContact_2 extends _i1.Fake implements _i4.SquadweContact {}

class _FakeSquadweConversation_3 extends _i1.Fake
    implements _i5.SquadweConversation {}
...
/// A class which mocks [SquadweClientAuthService].
///
/// See the documentation for Mockito's code generation for more information.
class MockSquadweClientAuthService extends _i1.Mock
    implements _i11.SquadweClientAuthService {
  MockSquadweClientAuthService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i3.Dio get dio =>
      (super.noSuchMethod(Invocation.getter(#dio), returnValue: _FakeDio_1())
          as _i3.Dio);
  @override
  _i7.Future<_i4.SquadweContact> createNewContact(
          String? inboxIdentifier, _i13.SquadweUser? user) =>
      (super.noSuchMethod(
              Invocation.method(#createNewContact, [inboxIdentifier, user]),
              returnValue:
                  Future<_i4.SquadweContact>.value(_FakeSquadweContact_2()))
          as _i7.Future<_i4.SquadweContact>);
  @override
  _i7.Future<_i5.SquadweConversation> createNewConversation(
          String? inboxIdentifier, String? contactIdentifier) =>
      (super.noSuchMethod(
              Invocation.method(
                  #createNewConversation, [inboxIdentifier, contactIdentifier]),
              returnValue: Future<_i5.SquadweConversation>.value(
                  _FakeSquadweConversation_3()))
          as _i7.Future<_i5.SquadweConversation>);
  @override
  String toString() => super.toString();
}
