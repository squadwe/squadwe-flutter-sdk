...
part of 'squadwe_user.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SquadweUserAdapter extends TypeAdapter<SquadweUser> {
  @override
  final int typeId = 3;

  @override
  SquadweUser read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, SquadweUser obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
...
SquadweUser _$SquadweUserFromJson(Map<String, dynamic> json) {
  return SquadweUser(
...
Map<String, dynamic> _$SquadweUserToJson(SquadweUser instance) =>
    <String, dynamic>{
