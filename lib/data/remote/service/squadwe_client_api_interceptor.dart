...
class SquadweClientApiInterceptor extends Interceptor {
  ...
  Future<void> onRequest(
    ...
    await requestLock.synchronized(() async {
      ...
      SquadweContact? contact = _localStorage.contactDao.getContact();
      SquadweConversation? conversation =
  ...
  /// response is returned from squadwe public client api
  @override
  Future<void> onResponse(
    ...
    await responseLock.synchronized(() async {
      if (response.statusCode == 401 ||
        ...
        await _localStorage.clear(clearSquadweUserStorage: false);
