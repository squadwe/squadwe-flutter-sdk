...
const SQUADWE_COLOR_PRIMARY = Color(0xff1f93ff);
const SQUADWE_BG_COLOR = Color(0xfff4f6fb);
const SQUADWE_AVATAR_COLORS = [SQUADWE_COLOR_PRIMARY];

/// Default squadwe chat theme which extends [ChatTheme]
@immutable
class SquadweChatTheme extends ChatTheme {
  /// Creates a squadwe chat theme. Use this constructor if you want to
  /// override only a couple of variables.
  const SquadweChatTheme({
    Widget? attachmentButtonIcon,
    Color backgroundColor = SQUADWE_BG_COLOR,
    ...
    Color primaryColor = SQUADWE_COLOR_PRIMARY,
    ...
    List<Color> userAvatarNameColors = SQUADWE_AVATAR_COLORS,
